  ...
  return (
    <div className="message-input-wrapper">
      <div className="message-input-container">
        {/* Mobile + menu toggle */}
        <div className="input-menu-wrapper" ref={menuRef}>
          <button
            className={`input-action-button input-menu-toggle ${showMenu ? "input-action-active" : ""}`}
          ...
          {showMenu && (
            <div className="input-menu-popup">
              <button className="input-menu-item" onClick={() => { setShowEmoji((v) => !v); setShowMenu(false); }} title="Add emoji">
              ...
              <button className="input-menu-item" onClick={() => { onAttachImage(); setShowMenu(false); }} title="Send a photo">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button className="input-menu-item" onClick={() => { onRecordAudio(); setShowMenu(false); }} title="Record voice message">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button className="input-menu-item" onClick={() => { onAttachDocument(); setShowMenu(false); }} title="Send a document">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="input-desktop-actions">
          <button
